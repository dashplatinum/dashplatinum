...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given dash platinum address.\n"
            "\nArguments:\n"
            "1. \"dashaddress\"     (string, required) The dash platinum address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"dashaddress\", (string) The dash platinum address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"")
            + HelpExampleRpc("validateaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"")
        );
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are dash platinum addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) dash platinum address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"dashaddress\"  (string, required) The dash platinum address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"]}")
        );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"]}")
        );
