...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Dash Platinum Core dashp-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dashp-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dash transaction") + "\n" +
              "  dashp-tx [options] -create [commands]   " + _("Create hex-encoded dash transaction") + "\n" +
              "\n";
