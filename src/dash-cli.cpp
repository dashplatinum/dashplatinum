...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Dash Platinum Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  dashp-cli [options] <command> [params]  " + _("Send command to Dash Platinum Core") + "\n" +
                  "  dashp-cli [options] help                " + _("List commands") + "\n" +
                  "  dashp-cli [options] help <command>      " + _("Get help for a command") + "\n";
