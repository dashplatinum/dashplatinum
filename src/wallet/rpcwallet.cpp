...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nReturns a new Dash Platinum address for receiving payments.\n"
            "If 'account' is specified (DEPRECATED), it is added to the address book \n"
            "so payments received with the address will be credited to 'account'.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. The account name for the address to be linked to. If not provided, the default account \"\" is used. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created if there is no account by the given name.\n"
            "\nResult:\n"
            "\"dashaddress\"    (string) The new dash platinum address\n"
            "\nExamples:\n"
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current Dash Platinum address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"dashaddress\"   (string) The account dash platinum address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new Dash Platinum address, for receiving change.\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"dashaddress\"  (string, required) The dash platinum address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\", \"tabby\"")
        );
    ...
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Dash Platinum address");
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"dashaddress\"  (string, required) The dash platinum address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"")
            + HelpExampleRpc("getaccount", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"")
        );
...
UniValue getaddressesbyaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"dashaddress\"  (string) a dash platinum address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 7)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"dashaddress\" (string, required) The dash platinum address to send to.\n"
            ...
            "                             The recipient will receive less amount of Dash Platinum than you enter in the amount field.\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            ...
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue listaddressgroupings(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"dashaddress\",     (string) The dash platinum address\n"
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"dashaddress\"  (string, required) The dash platinum address to use for the private key.\n"
            ...
            + HelpExampleCli("signmessage", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"dashaddress\"  (string, required) The dash platinum address for transactions.\n"
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\", 6")
       );
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 7)
        throw runtime_error(
            ...
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a dash platinum address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"fromaccount\"    (string, required) The name of the account to send funds from. May be the default account using \"\".\n"
            "2. \"todashaddress\"  (string, required) The dash platinum address to send funds to.\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 8)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount     (numeric or string) The dash platinum address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less dash platinums than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\\\":0.01,\\\"D6pRpbavxjQUBNAvsxPY36vDCMbc2MsVVg\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\\\":0.01,\\\"D6pRpbavxjQUBNAvsxPY36vDCMbc2MsVVg\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\\\":0.01,\\\"D6pRpbavxjQUBNAvsxPY36vDCMbc2MsVVg\\\":0.02}\", 6, false, \"testing\"")
        );
    ...
    BOOST_FOREACH(const string& name_, keys)
    {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Dash Platinum address: ")+name_);
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a Dash platinum address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keysobject\"   (string, required) A json array of dash platinum addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) dash platinum address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. An account to assign the addresses to.\n"

            "\nResult:\n"
            "\"dashaddress\"  (string) A dash platinum address associated with the keys.\n"
...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"dashaddress\",  (string) The dash platinum address of the transaction. Not present for \n"
...
UniValue listsinceblock(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"dashaddress\",  (string) The dash platinum address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"dashaddress\",      (string) The dash platinum address involved in the transaction\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() < 2 || params.size() > 3))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending dash platinums\n"
            "\nArguments:\n"
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\" 1.0") +
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending dash platinum\n"
    ...
    StartShutdown();
    return "Wallet encrypted; Dash Platinum Core server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending dash platinums.\n"
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "3. \"addresses\"      (string) A json array of dash platinum addresses to filter\n"
            "    [\n"
            "      \"address\"     (string) dash platinum address\n"
            "      ,...\n"
            "    ]\n"
            "\nResult\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the dash platinum address\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\\\",\\\"D6pRpbavxjQUBNAvsxPY36vDCMbc2MsVVg\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"D8vZ2TJwxGKvLPkTxtN91fWP4z7rUmbvhX\\\",\\\"D6pRpbavxjQUBNAvsxPY36vDCMbc2MsVVg\\\"]\"")
        );
    ...
    if (params.size() > 2) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Dash Platinum address: ")+input.get_str());
            if (setAddress.count(address))
